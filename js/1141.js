(function () {
    var e = {
        VERSION: "1.1.4", RELEASE: "2012-10-11", PATH: function () {
            ...
            n = n || {};
            var r = document.getElementsByTagName("head")[0] || document.documentElement, i = document.createElement("script"), s = !1;
            ...
            return function (n, r, i) {
                i = i || {};
                var s = "QWJsonp" + t++, o = i.callbackReplacer || /%callbackfun%/ig;
                window[s] = function (e) {
                    r && r(e), window[s] = null
                }, o.test(n) ? n = n.replace(o, s) : n += (/\?/.test(n) ? "&" : "?") + "callback=" + s, e.loadJs(n, i.oncomplete, i)
            }
        }(), loadCss: function (e) {
            var t = document.getElementsByTagName("head")[0] || document.documentElement, n = document.createElement("link");
    ...
    function n() {
        for (var e = 0; e < u.length; e++) {
            var t = u[e].callback, n = u[e].moduleNames.split(/\s*,\s*/g), r = !0;
    ...
    function r() {
        function e() {
            t.loadStatus = 2, n(), isLoading = !1, r()
        }

        var t = o[0];
        if (!isLoading && t) {
            isLoading = !0, o.splice(0, 1);
            var i = t.loadedChecker;
            i && i() ? e() : s(t.url.replace(/^\/\//, QW.PATH), e)
        }
    }

    var i = {}, s = QW.loadJs, o = [], u = [];
    isLoading = !1;
    var a = {
        provideDomains: [QW], provide: function (e, n) {
            if (typeof e == "string") {
            ...
            if (typeof n == "string") {
                var s = e({}, r);
                s.moduleName = n, i[n] = s
            } else if (t(n))for (var o in n)a.addConfig(o, n[o])
        }, use: function (e, t) {
            var n = {}, s = [], a = e.split(/\s*,\s*/g), f, l, c, h, p;
            while (a.length) {
                var d = {};
            ...
            for (f = 0, h = s.length; f < h; f++) {
                ...
                for (l = f + 1; l < h; l++)if ((new RegExp("(^|,)" + s[l].moduleName + "(,|$)")).test(s[f].requires)) {
                    var w = s[l];
                    s.splice(l, 1), s.splice(f, 0, w), f--;
                    break
                }
            }
            var E = -1, S = -1;
            for (f = 0; f < s.length; f++)p = s[f], !p.loadStatus && (new RegExp("(^|,)" + p.moduleName + "(,|$)")).test(e) && (E = f), p.loadStatus == 1 && (new RegExp("(^|,)" + p.moduleName + "(,|$)")).test(e) && (S = f);
            if (E == -1 && S == -1) {
                t();
                return
            }
            u.push({callback: t, moduleNames: e});
            for (f = 0; f < s.length; f++)p = s[f], p.loadStatus || (p.loadStatus = 1, o.push(p));
            r()
        }
    };
...
(function () {
    var e = {
        trim: function (e) {
            ...
            return function (r, i) {
                var s = -1, o = [], u = [[/\{strip\}([\s\S]*?)\{\/strip\}/g, function (e, t) {
                    return t.replace(/[\r\n]\s*\}/g, " }").replace(/[\r\n]\s*/g, "")
                }], [/\\/g, "\\\\"], [/"/g, '\\"'], [/\r/g, "\\r"], [/\n/g, "\\n"], [/\{[\s\S]*?\S\}/g, function (e) {
                    ...
                    var i = n[r];
                    if (i) {
                        if (i.isBgn)var u = o[++s] = {tagG: i.tagG, rlt: i.rlt};
                        if (i.isEnd) {
            ...
            return e.mulReplace(t, [[/[\uff01-\uff5e]/g, function (e) {
    ...
    var t = QW.StringH.escapeChars, n = {
        isString: function (t) {
            return e(t) == "String"
            ...
            if (n.isArray(t))for (var i = 0; i < t.length; i++)n.set(e, t[i], r[i]); else if (n.isPlainObject(t))for (i in t)n.set(e, i, t[i]); else if (n.isFunction(t)) {
            ...
            if (typeof r == "function")for (i in t)e[i] = r(e[i], t[i], i); else for (i in t)if (r || !(e[i] || i in e))e[i] = t[i];
            return e
        }, dump: function (e, t) {
            var n = {};
            for (var r = 0, i = t.length; r < i; r++)if (r in t) {
                var s = t[r];
                s in e && (n[s] = e[s])
            }
            return n
            ...
            for (var n in e) {
                ...
                if (e[n]instanceof Array)for (var r = 0; r < e[n].length; r++)t.push(encodeURIComponent(n) + "=" + encodeURIComponent(e[n][r])); else t.push(encodeURIComponent(n) + "=" + encodeURIComponent(e[n]))
            }
            return t.join("&")
        }
    };
    ...
    var e = QW.ObjectH.isArray, t = {
        map: function (e, t, n) {
            ...
            var n = [], r = null, i = Array.indexOf || t.indexOf;
        ...
        methodize: function (e, t) {
            ...
            return n ? function () {
                ...
                if (t instanceof Array) {
                    var n = [].slice.call(arguments), s = [], o = 0, u = t.length, a;
                    for (; o < u; o++) {
                        n[0] = t[o], a = e.apply(this, n);
                        if (r)a != null && (s = s.concat(a)); else if (i) {
            ...
            return n == null && (n = 0), function () {
                var i = e.apply(this, arguments);
                if (r && i !== undefined)return i;
                if (n >= 0)i = arguments[n]; else if (n == "this" || n == "context")i = this;
                return t ? new t(i) : i
            }
        }, hook: function (e, t, n) {
            ...
            if (t == "after")return function () {
                var r = [].slice.call(arguments), i = e.apply(this, r);
                return n.call(this, i, e, t)
            };
            throw new Error("unknow hooker:" + t)
        }, bind: function (e, t) {
            var n = [].slice, r = n.call(arguments, 2), i = function () {
            }, s = function () {
    ...
    var e = QW.ObjectH.mix, t = QW.ObjectH.create, n = {
    ...
    var e = QW.FunctionH, t = QW.ObjectH.create, n = QW.ObjectH.isPlainObject, r = function () {
    }, i = {
    ...
    var e = QW.ObjectH.mix, t = QW.ArrayH.indexOf, n = function (t, n, r) {
        this.target = t, this.type = n, e(this, r || {})
    };
    e(n.prototype, {
        target: null, currentTarget: null, type: null, returnValue: undefined, preventDefault: function () {
            this.returnValue = !1
        }
    });
    var r = {
    ...
    function t(t, n) {
        var r = [], i = t.length, s = 0, o;
        if (n == e) {
            if (t instanceof Array)return t.slice(0);
            for (; s < i; s++)r[s] = t[s]
        } else for (; s < i;)o = t[s++], n(o) && r.push(o);
        return r
    }

    function n(e) {
        var t = e.children || e.childNodes, n = t.length, r = [], i = 0;
        for (; i < n; i++)t[i].nodeType == 1 && r.push(t[i]);
        return r
    }

    function r(e) {
        var t = document.getElementById(e), n;
        if (t && t.id != e) {
    ...
    function i(e, t, n) {
        if (t == "n")return !0;
        if (typeof e == "number")var r = e; else {
            var i = e.parentNode;
            if (i.__queryStamp != m) {
                var s = {nextSibling: i.firstChild}, o = 1;
                while (s = s.nextSibling)s.nodeType == 1 && (s.__siblingIdx = o++);
                i.__queryStamp = m, i.__childrenNum = o - 1
            }
        ...
        switch (t) {
            ...
            default:
                ...
                var u = t.replace(/(^|\D+)n/g, "$11n").split("n"), a = u[0] | 0, f = r - u[1] | 0;
                return a * f >= 0 && f % a == 0
        }
    }
    ...
    function s(n, r) {
        if (!r && v[n])return v[n];
        var i = [], s = l(n), o = /\[\s*((?:[\w\u00c0-\uFFFF-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/g, u = [];
        s = s.replace(/\:([\w\-]+)(\(([^)]+)\))?/g, function (e, t, n, r, s) {
            return i.push([t, r]), ""
        ...
        for (var a = 0, f; f = i[a]; a++) {
            if (!h._pseudos[f[0]])throw"Unsupported Selector:\n" + f[0] + "\n" + s;
            u.push('__SltPsds["' + f[0] + '"](el,"' + (f[1] != null ? c(f[1]) : "") + '",i,els)')
        }
        return u.length ? r ? new Function("els", "var els2=[];for(var i=0,el;el=els[i];i++){if(" + u.join("&&") + ") els2.push(el);} return els2;") : v[n] = new Function("el, i, els", "return " + u.join("&&") + ";") : r ? function (n) {
            return t(n, e)
        } : v[n] = e
    }
    ...
    function o(e, t) {
        if (d && /^((^|,)\s*[.\w-][.\w\s\->+~]*)+$/.test(t)) {
            ...
            for (var o = 0, u = s.length; o < u; o++)i.push(s[o]);
            return i
        }
        return null
    }
    ...
    function u(e, t) {
        ...
        for (var S = 0, x, T; T = l[S]; S++)if (/^[.\w-]*#([\w-]+)/i.test(T[1])) {
        ...
        if (S < E) {
            var N = r(x);
            if (!N)return [];
            for (h = 0, m; m = c[h++];)if (!m.parentNode || p(m, N))return i = f(m, [N], l.slice(0, S + 1)), !i.length || S == E - 1 ? i : u(N, l.slice(S + 1).join(",").replace(/,/g, " "));
            return []
        }
        var C = function (e) {
            return e.getElementsByTagName(k)
        }, k = "*", L = "";
        t = l[E - 1][1], t = t.replace(/^[\w\-]+/, function (e) {
            return k = e, ""
        }), d && (t = t.replace(/^[\w\*]*\.([\w\-]+)/, function (e, t) {
            return L = t, ""
        })), L && (C = function (e) {
            return e.querySelectorAll(k + "." + L)
        });
        if (E == 1) {
            l[0][0] == ">" ? (C = n, b = s(l[0][1], !0)) : b = s(t, !0), i = [];
    ...
    function a(e) {
        var t = [], n = /(^|\s*[>+~ ]\s*)(([\w\-\:.#*]+|\([^\)]*\)|\[\s*((?:[\w\u00c0-\uFFFF-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\6|)\s*\])+)(?=($|\s*[>+~ ]\s*))/g, r = l(e).replace(n, function (e, n, r, i) {
            return t.push([l(n), r]), ""
        });
    ...
    function f(e, n, r) {
        var i = r[0], o = r.length, u = !i[0], a = [], f = [], l = [], c = "";
        for (var p = 0; p < o; p++) {
            i = r[p], a[p] = s(i[1], p == o - 1), f[p] = h._relations[i[0]];
            if (i[0] == "" || i[0] == "~")l[p] = !0;
            c += i[0] || " "
        }
        n = a[o - 1](n);
        if (c == " ")return n;
        if (/[+>~] |[+]~/.test(c))return t(n, function (t) {
            var n = [], r = o - 1, i = n[r] = t;
            for (; r > -1; r--) {
                if (r > 0)i = f[r](i, a[r - 1], e); else {
    ...
    var l = QW.StringH.trim, c = QW.StringH.encode4Js, h = {
        queryStamp: 0,
        _operators: {
            "": "aa",
            "=": 'aa=="vv"',
        ...
        query: function (e, t) {
            h.queryStamp = m++, e = e || document;
            var n = o(e, t);
            if (n)return n;
            var r = l(t).split(",");
            n = u(e, r[0]);
            for (var i = 1, s; s = r[i]; i++) {
                var a = u(e, s);
                n = n.concat(a)
            }
            return n
    ...
    (function () {
        ...
        e.innerHTML = '<div class="aaa"></div>', d = e.querySelectorAll && e.querySelectorAll(".aaa").length == 1, p = e.contains ? function (e, t) {
    ...
    var e = QW.Selector, t = QW.Browser, n = {
        query: function (t, n) {
            return e.query(n || document.documentElement, t)
        }, getDocRect: function (e) {
            e = e || document;
            var n = e.defaultView || e.parentWindow, r = e.compatMode, i = e.documentElement, s = n.innerHeight || 0, o = n.innerWidth || 0, u = n.pageXOffset || 0, a = n.pageYOffset || 0, f = i.scrollWidth, l = i.scrollHeight;
            ...
            return function (r, i, s) {
                var o = s && s.createElement("div") || e, u = o, a = (n.exec(r) || ["", ""])[1], f = t[a] || t._default, l = f[0];
            ...
            n = n || document;
            if (/complete/.test(n.readyState))e(); else if (n.addEventListener)!t.ie && "interactive" == n.readyState ? e() : n.addEventListener("DOMContentLoaded", e, !1); else {
                var r = function () {
                    r = new Function, e()
                };
                (function () {
            ...
            var n = Math.max(e.top, t.top), r = Math.min(e.right, t.right), i = Math.min(e.bottom, t.bottom), s = Math.max(e.left, t.left);
            return i >= n && r >= s ? {top: n, right: r, bottom: i, left: s} : null
    ...
    function e(e, t) {
        if ("string" == typeof e) {
            ...
            var n = (t || document).getElementById(e), i;
            if (n && n.id != e) {
    ...
    function n(e, t) {
        ...
        var n = e.style.right, r = e.runtimeStyle.right, i;
    ...
    var r = QW.ObjectH, i = QW.StringH, s = QW.DomU, o = QW.Browser, u = QW.Selector, a = u.selector2Filter, f = {
        outerHTML: function () {
        ...
        removeClass: function (n, r) {
            n = e(n), f.hasClass(n, r) && (n.className = n.className.replace(new RegExp("(?:^|\\s)" + t(r) + "(?=\\s|$)", "ig"), ""))
        },
        replaceClass: function (n, r, i) {
            n = e(n), f.hasClass(n, r) ? n.className = n.className.replace(new RegExp("(^|\\s)" + t(r) + "(?=\\s|$)", "ig"), "$1" + i) : f.addClass(n, i)
        },
        ...
        show: function () {
            function t(e) {
                if (!n[e]) {
                    var t = document.createElement(e), r = document.body;
                    f.insertSiblingBefore(r.firstChild, t), display = f.getCurrentStyle(t, "display"), f.removeChild(r, t), r = t = null;
            ...
            return function (n, r) {
                ...
                if (!r) {
                    ...
                    i === "none" && (i = n.style.display = ""), i === "" && f.getCurrentStyle(n, "display") === "none" && (i = t(n.nodeName))
                }
                n.style.display = r || i
            }
        }(),
        ...
        wrap: function (t, n) {
            t = e(t), n = e(n, t.ownerDocument), t.parentNode.insertBefore(n, t), n.appendChild(t)
        },
        unwrap: function (t) {
            t = e(t);
            var n = t.parentNode;
        ...
        isVisible: function (t) {
            return t = e(t), !!(t.offsetHeight + t.offsetWidth && f.getStyle(t, "display") != "none")
        },
        getXY: function () {
            var e = function (e, t) {
                var n = parseInt(f.getCurrentStyle(e, "borderTopWidth"), 10) || 0, r = parseInt(f.getCurrentStyle(e, "borderLeftWidth"), 10) || 0;
                return o.gecko && /^t(?:able|d|h)$/i.test(e.tagName) && (n = r = 0), t[0] += r, t[1] += n, t
            };
            return document.documentElement.getBoundingClientRect ? function (e) {
                var t = e.ownerDocument, n = s.getDocRect(t), r = n.scrollX, i = n.scrollY, u = e.getBoundingClientRect(), a = [u.left, u.top], f, l, c;
                ...
                var n = [t.offsetLeft, t.offsetTop], r = t.parentNode, i = t.ownerDocument, u = s.getDocRect(i), a = !!(o.gecko || parseFloat(o.webkit) > 519), l = 0, c = 0;
                while (r = r.offsetParent)n[0] += r.offsetLeft, n[1] += r.offsetTop, a && (n = e(r, n));
                if (f.getCurrentStyle(t, "position") != "fixed") {
                    r = t;
                    while (r = r.parentNode) {
                        l = r.scrollTop, c = r.scrollLeft, o.gecko && f.getCurrentStyle(r, "overflow") !== "visible" && (n = e(r, n));
                        if (l || c)n[0] -= c, n[1] -= l
                    }
                }
                return n[0] += u.scrollX, n[1] += u.scrollY, n
            }
        }(),
        setXY: function (t, n, r) {
            t = e(t), n = parseInt(n, 10), r = parseInt(r, 10), isNaN(n) || f.setStyle(t, "left", n + "px"), isNaN(r) || f.setStyle(t, "top", r + "px")
        },
        setSize: function (t, n, r) {
            t = e(t), n = parseFloat(n, 10), r = parseFloat(r, 10);
            if (isNaN(n) && isNaN(r))return;
            var i = f.borderWidth(t), s = f.paddingWidth(t);
            isNaN(n) || f.setStyle(t, "width", Math.max(+n - i[1] - i[3] - s[1] - s[3], 0) + "px"), isNaN(r) || f.setStyle(t, "height", Math.max(+r - i[0] - i[2] - s[0] - s[2], 0) + "px")
        },
        setInnerSize: function (t, n, r) {
            t = e(t), n = parseFloat(n, 10), r = parseFloat(r, 10), isNaN(n) || f.setStyle(t, "width", n + "px"), isNaN(r) || f.setStyle(t, "height", r + "px")
        },
        ...
        getSize: function (t) {
            return t = e(t), {width: t.offsetWidth, height: t.offsetHeight}
        },
        getRect: function (t) {
            t = e(t);
            var n = f.getXY(t), r = n[0], i = n[1], s = t.offsetWidth, o = t.offsetHeight;
            return {width: s, height: o, left: r, top: i, bottom: i + o, right: r + s}
        },
        ...
        siblings: function (e, t) {
            var n = a(t || ""), r = e.parentNode.firstChild, i = [];
        ...
        contains: function (t, n) {
            return t = e(t), n = e(n), t.contains ? t != n && t.contains(n) : !!(t.compareDocumentPosition(n) & 16)
        },
        insertAdjacentHTML: function (t, n, r) {
            t = e(t);
            if (t.insertAdjacentHTML)t.insertAdjacentHTML(n, r); else {
                var i = t.ownerDocument.createRange(), s;
                i.setStartBefore(t), s = i.createContextualFragment(r), f.insertAdjacentElement(t, n, s)
            }
        },
        insertAdjacentElement: function (t, n, r) {
            t = e(t), r = e(r);
            if (t.insertAdjacentElement)t.insertAdjacentElement(n, r); else switch (String(n).toLowerCase()) {
                case"beforebegin":
        ...
        removeNode: function (t) {
            return t = e(t), t.parentNode.removeChild(t)
        },
        removeChild: function (t, n) {
            return e(t).removeChild(e(n))
        },
        get: function (t, n) {
            return t = e(t), r.get.apply(null, arguments)
        },
        set: function (t, n, i) {
            t = e(t), r.set.apply(null, arguments)
        },
        getAttr: function (t, n, r) {
            return t = e(t), n = f.attrMap[n] || n, n in t && "href" != n ? t[n] : t.getAttribute(n, r || t.nodeName == "A" && n.toLowerCase() == "href" && 2 || null)
        },
        setAttr: function (t, n, r, i) {
            t = e(t);
            if ("object" != typeof n)n = f.attrMap[n] || n, n in t ? t[n] = r : t.setAttribute(n, r, i || null); else for (var s in n)f.setAttr(t, s, n[s])
        },
        removeAttr: function (t, n, r) {
            return t = e(t), t.removeAttribute(n, r || 0)
        },
        query: function (t, n) {
            return t = e(t), u.query(t, n || "")
        },
        one: function (t, n) {
            return t = e(t), u.one(t, n || "")
        },
        ...
        setHtml: function () {
            var t = /<(?:object|embed|option|style)/i, n = function (e, t) {
                f.empty(e), f.appendChild(e, s.create(t, !0))
            };
            return function (r, i) {
                r = e(r);
                if (!t.test(i))try {
        ...
        encodeURIForm: function (t, n) {
            t = e(t), n = n || function (e) {
                return !1
            };
            var r = [], i = t.elements, s = i.length, o = 0, u = function (e, t) {
        ...
        isFormChanged: function (t, n) {
            ...
            var r = t.elements, i = r.length, s = 0, o = 0, u;
            for (; s < i; ++s, o = 0) {
                t = r[s];
                if (n(t))continue;
                switch (t.type) {
        ...
        removeStyle: function (t, n) {
            t = e(t);
            var r = i.camelize(n), s = f.cssHooks[r];
            s ? s.remove(t) : t.style.removeProperty ? t.style.removeProperty(i.decamelize(n)) : t.style.removeAttribute(r)
        },
        getStyle: function (t, n) {
            t = e(t), n = i.camelize(n);
            var r = f.cssHooks[n], s;
            return r ? s = r.get(t) : s = t.style[n], !s || s == "auto" ? null : s
        },
        getCurrentStyle: function (t, n, r) {
            t = e(t);
            var s = i.camelize(n), u = f.cssHooks[s], a;
            if (u)a = u.get(t, !0, r); else if (o.ie)a = t.currentStyle[s]; else {
                var l = t.ownerDocument.defaultView.getComputedStyle(t, r || null);
                a = l ? l.getPropertyValue(i.decamelize(n)) : null
            }
        ...
        setStyle: function (t, n, r) {
            t = e(t);
            if ("object" != typeof n) {
                var s = i.camelize(n), o = f.cssHooks[s];
                o ? o.set(t, r) : t.style[s] = r
            } else for (var u in n)f.setStyle(t, u, n[u])
        },
        borderWidth: function () {
            var t = {thin: 2, medium: 4, thick: 6}, n = function (e, n) {
        ...
        tmpl: function (t, n) {
            return t = e(t), i.tmpl(t.innerHTML, n)
        },
        attrMap: {
            "class": "className",
            "for": "htmlFor",
                ...
                if (n && !/^0.55$/.test(n.style.opacity)) {
                    ...
                    e.opacity = {
                        get: function (e, t) {
                            ...
                            n.zoom = 1;
                            var s = "alpha(opacity=" + t * 100 + ")", o = i && i.filter || n.filter || "";
                            n.filter = r.test(o) ? o.replace(r, s) : o + " " + s
                        }, remove: function (e) {
                            var t = e.style, n = e.currentStyle, i = n && n.filter || t.filter || "";
                            r.test(i) && (t.filter = i.replace(r, "")), t.removeAttribute("opacity")
                        }
                    }
                }
            }
    ...
    var e = QW.ObjectH, t = e.mix, n = e.isString, r = e.isArray, i = Array.prototype.push, s = QW.NodeH, o = s.g, u = s.query, a = s.one, f = QW.DomU.create, l = function (e) {
        if (!e)return null;
        if (e instanceof l)return e;
        var t = arguments[1];
        if (n(e)) {
            if (/^</.test(e)) {
                var s = f(e, !0, t).childNodes, a = [];
    ...
    function e(e) {
        var n = t.getTarget(e), r = document;
    ...
    var t = {
        getPageX: function (n) {
            ...
            do if (/Event/.test(n.arguments[0]))return n.arguments[0]; while (n = n.caller)
        }, _EventPro: {
    ...
    function e(e, t, r, i) {
        return o.get(e, t + (i ? "." + i : ""), r) || function (s) {
                if (!i || i && u._EventHooks[i][t](e, s, r))return n(e, s, r, t)
            }
    }

    function t(e, t, r, i, s) {
        return o.get(e, r + (s ? "." + s : ""), i, t) || function (o) {
                var a = [], f = o.srcElement || o.target;
                if (!f)return;
                f.nodeType == 3 && (f = f.parentNode);
                while (f && f != e)a.push(f), f = f.parentNode;
                a = QW.Selector.filter(a, t, e);
                for (var l = 0, c = a.length; l < c; ++l) {
                    (!s || s && u._DelegateHooks[s][r](a[l], o || window.event, i)) && n(a[l], o, i, r);
    ...
    var r = QW.NodeH.g, i = QW.ObjectH.mix, s = QW.EventH.standardize, o = function () {
        var e = 1, t = "__QWETH_id";
        return {
            get: function (e, n, r, i) {
                ...
                if (i) {
                    ...
                    for (var o in i)if (s.test(o) && (!r || o.substr(o.length - r.length) == r)) {
                        var a = o.split(/\d+/)[0].split("."), f = u._DelegateCpatureEvents.indexOf(a[1] || a[0]) > -1;
        ...
        fireHandler: function (e, t, n, r) {
            return t = s(t), t.userType = r, n.call(e, t)
        },
        ...
        on: function (t, n, i) {
            ...
            if (f)for (var a in f) {
                var l = e(t, a, i, n);
                o.add(l, t, a + "." + n, i), a == n ? u.addEventListener(t, a, l) : u.on(t, a, l)
            } else l = e(t, n, i), u.addEventListener(t, n, l), o.add(l, t, n, i)
        },
        un: function (t, n, i) {
            if (n && n.indexOf(",") > -1) {
                var s = n.split(/\s*,\s*/);
            ...
            if (f)for (var a in f) {
                var l = e(t, a, i, n);
                a == n ? u.removeEventListener(t, a, l) : u.un(t, a, l), o.remove(t, a + "." + n, i)
            } else l = e(t, n, i), u.removeEventListener(t, n, l), o.remove(t, n, i)
        },
        once: function (e, t, n) {
            e = r(e);
            var i = function () {
        ...
        delegate: function (e, n, i, s) {
            ...
            e = r(e);
            var l = u._DelegateHooks[i], c = u._DelegateCpatureEvents.indexOf(i) > -1;
            if (l)for (var f in l) {
                var h = t(e, n, f, s, i);
                o.add(h, e, f + "." + i, s, n), f == i ? u.addEventListener(e, f, h, c) : u.delegate(e, n, f, h)
            } else h = t(e, n, i, s), u.addEventListener(e, i, h, c), o.add(h, e, i, s, n)
        },
        undelegate: function (e, n, i, s) {
            ...
            if (l)for (var f in l) {
                var h = t(e, n, f, s, i);
                f == i ? u.removeEventListener(e, f, h, c) : u.undelegate(e, n, f, h), o.remove(e, f + "." + i, s, n)
            } else h = t(e, n, i, s), u.removeEventListener(e, i, h, c), o.remove(e, i, s, n)
        },
        fire: function () {
            return document.dispatchEvent ? function (e, t) {
                var n = null, r = e.ownerDocument || e;
    ...
    u._defaultExtend = function () {
        ...
        e("submit,reset,click,focus,blur,change,select".split(",")), u.hover = function (e, t, n) {
        ...
        if (!document.addEventListener) {
            ...
            function s(e, t) {
                ...
                if (n(r) != r.__QWETH_pre_val)return o(e, t), !0
            }
    ...
    var t = QW.ObjectH.mix, n = QW.JSON.parse, r = {};
    t(r, {
        rules: {}, addRule: function (e, n) {
    ...
    QW.Jss = r, QW.JssTargetH = i
}(), function () {
    var e = "queryer", t = "operator", n = "getter_all", r = "getter_first", i = "getter_first_all";
    QW.NodeC = {
        getterType: r,
    ...
    var e = QW.HelperH.methodize, t = QW.ObjectH.mix;
    ...
    var e = QW.ObjectH.mix, t = QW.HelperH.methodize, n = QW.HelperH.rwrap, r = QW.NodeC, i = QW.NodeH, s = QW.EventTargetH, o = QW.JssTargetH, u = QW.DomU, a = QW.NodeW;
    a.pluginHelper(i, r.wrapMethods, r.gsetterMethods), a.pluginHelper(s, "operator"), a.pluginHelper(o, r.wrapMethods, {jss: ["", "getJss", "setJss"]});
    ...
    QW.EventTargetH._DelegateHooks.click = QW.EventTargetH._EventHooks.click = {click: e}, QW.EventTargetH._EventHooks.submit = {submit: e}
    ...
    var t = QW.ObjectH.isString, n = {
        wait: function (n, r, i) {
            t(r) || (i = r, r = "_default"), i = i || function () {
            };
            var s = e(n, r);
            s.push(i), s.length <= 1 && (/^_/.test(r) || (i = function () {
            }, s.unshift(i)), i.call(n))
        }, signal: function (t, r, i) {
            r = r || "_default";
            var s = e(t, r), o = s.shift();
            return s[0] && (function (e) {
                e.call(t)
            }(s[0]), i && n.signal(t, r, i)), !!o
        }, clearSignals: function (t, n) {
            var r = e(t, n), i = r.length;
            return r.length = 0, !!i
        }
    };
    QW.provide("AsyncH", n)
}(), function () {
    var e = QW.NodeW, t = QW.AsyncH, n = QW.HelperH.methodize;
    ...
    var t = QW.ObjectH.mix, n = QW.ObjectH.encodeURIJson, r = QW.NodeH.encodeURIForm, i = QW.CustEvent;
    t(e, {
        STATE_INIT: 0,
        STATE_REQUEST: 1,
        STATE_SUCCESS: 2,
        ...
        request: function (t, n, r, i) {
            if (t.constructor == Object)var s = new e(t); else typeof n == "function" && (i = r, r = n, t && t.tagName == "FORM" ? (i = i || t.method, n = t, t = t.action) : n = ""), s = new e({
                url: t,
                method: i,
                data: n,
                onsucceed: function () {
        ...
        get: function (t, n, r) {
            ...
            return i.push("get"), e.request.apply(null, i)
        },
        post: function (t, n, r) {
            var i = [].slice.call(arguments, 0);
            return i.push("post"), e.request.apply(null, i)
        }
    }), t(e.prototype, {
        url: "",
        method: "get",
        ...
        send: function (t, i, s) {
            ...
            t = t || o.url, t = t.split("#")[0], i = (i || o.method || "").toLowerCase(), i != "post" && (i = "get"), s = s || o.data, typeof s == "object" && (s.tagName == "FORM" ? s = r(s) : s = n(s)), s && i != "post" && (t += (t.indexOf("?") != -1 ? "&" : "?") + s), o.user ? u.open(i, t, o.async, o.user, o.pwd) : u.open(i, t, o.async);
            for (var a in o.requestHeaders)u.setRequestHeader(a, o.requestHeaders[a]);
            o.isLocked = 0, o.state = e.STATE_INIT, o.async && (o._sendTime = new Date, o.useLock && (o.isLocked = 1), this.requester.onreadystatechange = function () {
                var e = o.requester.readyState;
                e == 4 && o._execComplete()
            }, o._checkTimeout()), i == "post" ? (s || (s = " "), u.send(s)) : u.send(null);
        ...
        _execComplete: function () {
            var t = this, n = t.requester;
            n.onreadystatechange = new Function, t.isLocked = 0, clearTimeout(this._timer), t.state != e.STATE_CANCEL && t.state != e.STATE_TIMEOUT && (t.isSuccess() ? (t.state = e.STATE_SUCCESS, t.fire("succeed", t.requester.responseText)) : (t.state = e.STATE_ERROR, t.fire("error", t.requester.responseText))), t.fire("complete", t.requester.responseText)
        }
    }), QW.provide("Ajax", e)
}(), function () {
    var e = QW.Ajax, t = QW.NodeW;
    e.Delay = 1e3, e.prototype.opResults = function (e) {
        ...
        try {
            ...
            return alert("\u7cfb\u7edf\u9519\u8bef\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5\u3002"), {isop: !0, err: "inter"}
        }
        r.isop = !0;
        switch (r.err) {
            default:
    ...
    var n = {
        ajaxForm: function (t, n) {
            var r = {data: t, url: t.action, method: t.method};
    ...
    var r = QW.CustEvent, i = QW.ObjectH.mix, s = function (e, t, o) {
        i(this, o), i(this, {
            animFun: e,
            dur: t,
            byStep: !1,
            ...
            frameTime: 28,
            _status: 0
        }), n(this, this.per), r.createEvents(this, s.EVENTS)
    };
    s.EVENTS = "beforeplay,play,step,pause,resume,end,reset".split(","), i(s.prototype, {
        isPlaying: function () {
            ...
            var t = this;
            e != null ? n(t, e) : (t.byStep ? e = t._currentStep++ / t._totalStep : e = (new Date - t._startDate) / t.dur, this.per = e), this.per > 1 && (this.per = 1), t.animFun(this.per), t.fire("step");
            if (this.per >= 1) {
                this.end();
                return
            }
    ...
    var t = QW.NodeH, n = QW.ObjectH.mix, r = QW.ObjectH.isObject, i = n, s = t.g, o = t.getCurrentStyle, u = t.setStyle, a = t.getSize, f = QW.DomU.isElement, l = QW.ArrayH.forEach, c = QW.ArrayH.map, h = QW.Anim, p = t.show, d = t.hide, v = t.isVisible, m = ["zIndex", "fontWeight", "opacity", "lineHeight"], g = function (e, t, i) {
        this.el = e, this.attr = i, r(t) || (t = {to: t}), n(this, t)
    };
    n(g.prototype, {
        getValue: function () {
            ...
            return m.contains(this.attr.camelize()) ? "" : "px"
        }, init: function () {
            var e, t, n;
    ...
    y.MENTOR_CLASS = g, n(y.prototype, {
        getValue: function () {
    ...
    b.MENTOR_CLASS = g, n(b.prototype, {
        parseColor: function (e) {
            ...
            null != this.from ? e = this.from : e = this.getValue(), e = r(e), t = this.to || [0, 0, 0], t = r(t), n = this.by ? r(this.by) : c(t, function (t, n) {
                return t - e[n]
    ...
    var w = {color$: b, "^scroll": y, ".*": g}, E = function (t, n, r, o) {
        t = s(t);
        if (!f(t))throw new Error(["Animation", "Initialize Error", "Element Not Found!"]);
        r = r || E.DefaultEasing, o = typeof o == "function" ? o : E.DefaultEasing;
        var u = [], a = [];
        for (var c in n) {
            if (typeof n[c] == "string" && E.agentHooks[n[c]]) {
                var p = E.agentHooks[n[c]](c, t);
                p.callback && (a.push(p.callback), delete p.callback), n[c] = p
            }
            var d = e(w, c), v = new d(t, n[c], c);
            if (!v)continue;
            v.init(), v.easing = v.easing || o, u.push(v)
        }
        var m = new h(function (e) {
            l(u, function (t) {
                t.action(e)
            })
        }, r);
    ...
    E.MENTOR_CLASS = h, E.DefaultEasing = function (e) {
        return e
    }, E.DefaultDur = 500, E.Sequence = !1, E.agentHooks = function () {
        var e = function (e, t) {
            return /^(height|width)$/ig.test(t) ? a(e)[t] || 0 : o(e, t) || 0
        };
        return {
            show: function (t, n) {
                var r = 0, i = n["__anim" + t];
                return v(n) ? (r = e(n, t), i = typeof i == "undefined" ? e(n, t) : i) : (p(n), i = typeof i == "undefined" ? e(n, t) : i, u(n, t, 0)), {
                    from: r,
                    to: i
                }
            }, hide: function (t, n) {
                var r = e(n, t), i = "__anim" + t, s = n[i];
                typeof s == "undefined" && (v(n) ? s = r : (p(n), s = e(n, t), d(n)), n[i] = s);
                var o = function () {
                    d(n);
                    var e = n[i];
                    typeof e == "number" && !m.contains(t.camelize()) && (e += "px"), u(n, t, e)
                };
                return {from: r, to: 0, callback: o}
            }, toggle: function (e, t) {
                return v(t) ? E.agentHooks.hide.apply(this, arguments) : E.agentHooks.show.apply(this, arguments)
            }
        }
    }(), QW.provide({ElAnim: E, ScrollAnim: E, ColorAnim: E})
}(), function () {
    var e = {
        easeNone: function (e) {
            return e
    ...
    var t = QW.NodeH, n = t.g, r = t.isVisible, i = {
        animate: function (t, n, r, i, s, o) {
            for (var u = arguments.length - 1; u > 0; u--)if (arguments[u] === !!arguments[u]) {
                var a = arguments[u];
                arguments[u] = null, o = a;
                break
            }
            if (!QW.Async || !o && !QW.ElAnim.Sequence)return e(t, n, i, r, s);
            W(t).wait(function () {
                var o = e(t, n, i, r, s);
            ...
            var o = {opacity: "hide"};
            return i.animate(e, o, t, n, r, s)
        }, fadeToggle: function (e, t, n, s, o) {
            return i[r(e) ? "fadeOut" : "fadeIn"](e, t, n, s, o)
            ...
            var o = {height: "show"};
            return i.animate(e, o, t, n, r, s)
        }, slideToggle: function (e, t, n, s, o) {
            return i[r(e) ? "slideUp" : "slideDown"](e, t, n, s, o)
        }, shine4Error: function (e, t, n, r, s) {
            var o = {backgroundColor: {from: "#f33", to: "#fff", end: ""}};
            return i.animate(e, o, t, n, r, s)
        }
    };
